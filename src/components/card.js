...
<div className="card" style={{ width: '18rem', textAlign: 'center'}}>
  <button type='button' onClick={() => this.props.onIncrement(this.props.card)} className="btn btn-primary">Aggiungi<span className='badge bg-secondary'>{this.props.card.quantità}</span></button>
