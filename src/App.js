...
class App extends Component {
    state = {
      cards: [
       ...
       {id: 3, nome: 'Philadelphia', prezzo: 3.45, immagine: philadelphia, quantità: 0},
       {id: 4, nome: 'Rainbow', prezzo: 3.99, immagine: rainbow, quantità: 0},
       {id: 5, nome: 'Shrimp', prezzo: 4.49, immagine: shrimp, quantità: 0}
      ]
}

handleDelete = cardId => {
  const cards = this.state.cards.filter(card => card.id !== cardId);
  this.setState({cards}); //per aggiornare lo stato di un componente react
}
